...
class graph_chapterController extends Controller
{
    ...
    // return $test;
        ...
        $extenlevel = DB::table(DB::raw("(select chapter_id,id as group_id from groups where status = 1 and chapter_id = '$chapter_id' and line_code = '$line_code' order by id desc limit 1) lastgroup"))
        ...
        $scoreeverbody = DB::table(
          ...
          where subject_id = $subject_id and chapter_id = $chapter_id
