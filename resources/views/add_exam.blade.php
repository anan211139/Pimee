    ...
    <body>
      <div class="main-container">
        ...
        <div class="margin-content">
                ...
                <form action="/addExamSubmit" enctype="multipart/form-data" method="post" autocomplete="off">
                <div class="form-con">
                    <div class="grid-con">
                        <div>
                            <p>โจทย์*</p>
                        ...
                        <div>
                            ...
                            <p>ระดับ*</p>
                            <div>
                                <span class="radio-con" name="level" >
                                    <input type="radio" value="1" name="level" id="level1" required>
                                    <label for="level1">ยาก</label>
                                    <input type="radio" value="2" name="level" id="level2">
                                    <label for="level2">กลาง</label>
                                    <input type="radio" value="3" name="level" id="level3">
                                    <label for="level3">ง่าย</label>
                                </span>
                            </div>
                        </div>
                    </div>
